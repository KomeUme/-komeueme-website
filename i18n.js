const I18N = {
  ja: {
    ...
    shop_print_note: "※ 画像は参考作品です。エディションにより刷りの風合い・色味に個体差があります。<br>※ 販売可能なエディション番号には限りがあります。ご希望がある場合は、下部のContactよりお問い合わせください。<br>※ 受注生産の場合、発送まで1か月ほどお時間をいただくことがあります。",
    shop_tab_works: "作品",
  ...
  en: {
    ...
    shop_print_note: "Images are reference examples. Texture and color may vary by edition.<br>Available edition numbers are limited. If you have a preference, please contact us using the Contact link below.<br>Made-to-order items may take about one month to ship.",
