const I18N = {
  ja: {
    ...
    page_title_digital: "デジタル | Kome Ume",
    ...
    page_title_manga_4koma: "四コマ漫画 | Kome Ume",
    page_title_manga_story: "ストーリー漫画 | Kome Ume",
    ...
    intro_hanga: "版画",
    intro_hanga_desc: "木版画と銅版画を分けて掲載。",
    section_wood: "木版画",
    section_copper: "銅版画",
    intro_wood_desc: "木版画作品一覧。",
    intro_copper_desc: "銅版画作品一覧。",
    intro_digital: "デジタル",
    intro_digital_desc: "デジタル関連作品を掲載。",
    section_digital_illustration: "イラスト",
    section_digital_mini_chara: "ミニキャラ",
    intro_digital_illustration_desc: "デジタルイラスト作品一覧。",
    intro_digital_mini_chara_desc: "デジタルのミニキャラ作品一覧",
    intro_manga: "漫画",
    intro_manga_desc: "４コマ漫画、ストーリー漫画を掲載。",
    heading_manga_4koma: "四コマ漫画",
    heading_manga_story: "ストーリー漫画",
    ...
    intro_shop_desc: "販売サイト、SNS、問い合わせ先を置くためのページ。URLが決まったらボタンを差し替える。",
    ...
    card_contact_desc: "お仕事の依頼などは下記のメールまでお問い合わせ下さい。",
  ...
  en: {
    ...
    page_title_digital: "Digital | Kome Ume",
    ...
    intro_hanga_desc: "Separated into woodblock and intaglio.",
    section_wood: "Woodblock",
    section_copper: "Intaglio",
    intro_wood_desc: "Woodblock works list.",
    intro_copper_desc: "Intaglio works list.",
    intro_digital: "Digital",
    intro_digital_desc: "Digital-related works.",
    section_digital_illustration: "Illustration",
    section_digital_mini_chara: "Mini Character",
    intro_digital_illustration_desc: "Digital illustration works.",
    intro_digital_mini_chara_desc: "Digital mini character works.",
    intro_manga: "Manga",
    ...
    intro_shop_desc: "Page for shop links, SNS, and contact information.",
    card_shop_title: "Online Shop",
    ...
    card_sns_title: "SNS",
    card_sns_desc: "Printmaking posts are on @komeume1121, and digital posts are on @unomori1121.",
