const I18N = {
  ja: {
    ...
    intro_digital: "デジタル",
    intro_digital_desc: "キャラクター、グッズ展開、デジタルイラストの制作を整理。",
    intro_manga: "漫画",
    intro_manga_desc: "４コマ漫画、ストーリー漫画のネームを掲載。",
    manga_4koma: "四コマ漫画",
    manga_story: "ストーリー漫画",
    intro_shop: "販売・問い合わせ",
    ...
    card_shop_desc: "BASE、BOOTH、STORES、SUZURI などの販売URLを設定。",
  ...
  en: {
    ...
    top_hero_lead: "Woodblock, intaglio, and digital works with production details and captions.",
    ...
    intro_digital_desc: "Character, goods, and digital illustration works.",
    intro_manga: "Manga",
